...
final class AgentController {
    ...
    /// Continues processes a previous Foreman instance paused and never released.
    ...
    /// Agent (optionally) plus descendants, minus anything unsafe: Foreman itself and its
